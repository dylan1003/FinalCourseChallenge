/*
Deployment script for BasketBallDB
...
GO
:setvar DatabaseName "BasketBallDB"
:setvar DefaultFilePrefix "BasketBallDB"
...
CREATE TABLE [dbo].[Games] (
    ...
    CONSTRAINT [UQ_DateVenue] UNIQUE NONCLUSTERED ([MatchDate] ASC, [Venue] ASC)
);


GO
PRINT N'Creating [dbo].[CHK_CompleteValid]...';


GO
ALTER TABLE [dbo].[Games]
    ADD CONSTRAINT [CHK_CompleteValid] CHECK ([Completed] = 0 OR [Completed] = 1 OR [Completed] = 3);
